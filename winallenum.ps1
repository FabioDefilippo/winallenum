...
while($true){
    ...
    write-host " 259. scipag/PowerShellUtilities/Select-MimikatzDomainAccounts`t`t`t`t`t`t`t`t`t`t`t307. nettitude/Invoke-PowerThIEf";
    ...
    write-host " 244. phackt/Invoke-Recon`t`t`t`t`t292. Z3R0th-13/Enum`t`t`t`t`t293. duckingtoniii/Powershell-Domain-User-Enumeration";
    ...
    write-host " 313. chocolatey/install";
    write-host "MITM";
